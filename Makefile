...
ESTIMATOR_TRAJECTORY_Y_SCALE ?= log
ESTIMATOR_TRAJECTORY_TOLERANCE_BAND ?= 0.002
ESTIMATOR_TRAJECTORY_MIN_OBSERVATION ?=
ESTIMATOR_TRAJECTORY_MAX_OBSERVATION ?= 40000
ESTIMATOR_TRAJECTORY_TOLERANCE_BACKGROUND ?= 1
ESTIMATOR_TRAJECTORY_TOLERANCE_BACKGROUND_CMAP ?=berlin
ESTIMATOR_TRAJECTORY_TOLERANCE_BACKGROUND_MAX_MULTIPLE ?= 0.2
ESTIMATOR_TRAJECTORY_TOLERANCE_BACKGROUND_SCALE ?= linear
ESTIMATOR_TRAJECTORY_TOLERANCE_BACKGROUND_ALPHA ?= 0.85
...
ESTIMATOR_TRAJECTORY_ARGS += $(if $(ESTIMATOR_TRAJECTORY_MIN_OBSERVATION),--min-observation $(ESTIMATOR_TRAJECTORY_MIN_OBSERVATION))
ESTIMATOR_TRAJECTORY_ARGS += --max-observation $(ESTIMATOR_TRAJECTORY_MAX_OBSERVATION)
ESTIMATOR_TRAJECTORY_ARGS += $(if $(filter 0 false no,$(ESTIMATOR_TRAJECTORY_TOLERANCE_BACKGROUND)),--no-tolerance-background)
ESTIMATOR_TRAJECTORY_ARGS += --tolerance-background-cmap $(ESTIMATOR_TRAJECTORY_TOLERANCE_BACKGROUND_CMAP)
ESTIMATOR_TRAJECTORY_ARGS += --tolerance-background-max-multiple $(ESTIMATOR_TRAJECTORY_TOLERANCE_BACKGROUND_MAX_MULTIPLE)
ESTIMATOR_TRAJECTORY_ARGS += --tolerance-background-scale $(ESTIMATOR_TRAJECTORY_TOLERANCE_BACKGROUND_SCALE)
ESTIMATOR_TRAJECTORY_ARGS += --tolerance-background-alpha $(ESTIMATOR_TRAJECTORY_TOLERANCE_BACKGROUND_ALPHA)
ESTIMATOR_TRAJECTORY_ARGS += --tolerance-background-normalization $(ESTIMATOR_TRAJECTORY_TOLERANCE_BACKGROUND_NORMALIZATION)
ESTIMATOR_TRAJECTORY_ARGS += --figure-width-mm $(ESTIMATOR_TRAJECTORY_FIGURE_WIDTH_MM)
ESTIMATOR_TRAJECTORY_ARGS += --figure-height-mm $(ESTIMATOR_TRAJECTORY_FIGURE_HEIGHT_MM)
ESTIMATOR_TRAJECTORY_ARGS += --dpi $(ESTIMATOR_TRAJECTORY_DPI)
SNAPSHOT_3D_ARGS ?=

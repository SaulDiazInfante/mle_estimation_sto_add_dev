...
env \
    ...
    SPDE_THETA=0.1 \
    SPDE_SIGMA=1.0 \
    SPDE_MC_REPLICATES=2 \
    SPDE_MC_BASIS_LEVELS=4,6 \
    SPDE_MC_N_OBSERVATIONS=20,25 \
    SPDE_MC_TIME_STEPS=1.0e-4,5.0e-5 \
    SPDE_MC_SUMMARY_FILE="$SUMMARY_FILE" \
    SPDE_MC_REPLICATE_FILE="$REPLICATE_FILE" \
...
env \
    ...
    SPDE_THETA=0.1 \
    SPDE_SIGMA=1.0 \
    SPDE_MC_SUMMARY_FILE="$PAPER_SUMMARY_FILE" \
    SPDE_MC_REPLICATE_FILE="$PAPER_REPLICATE_FILE" \
